...
import { basicsTableData, EnTableType } from './tableData';
import {
  createColumnHelper,
  flexRender,
  getCoreRowModel,
...
import TablePagination from '@/app/components/common/Pagenation';
...
const QuestionList = ({ onClick }: Props) => {
                      ...
                      <TableRow>
                        <TableCell colSpan={columns.length}>
                          <Box p={2}>
                            ...
                            <Typography>
                              Avatar: <Avatar src={row.original.imgsrc} alt="Avatar" />
                            </Typography>
