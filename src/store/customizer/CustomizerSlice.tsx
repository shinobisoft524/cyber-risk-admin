...
interface StateType {
  ...
  activeTheme?: string; // SHINOBI_THEME, BLUE_THEME, GREEN_THEME, BLACK_THEME, PURPLE_THEME, ORANGE_THEME
  SidebarWidth?: number;
...
const initialState: StateType = {
  ...
  activeTheme: 'SHINOBI_THEME', // SHINOBI_THEME, BLUE_THEME, GREEN_THEME, BLACK_THEME, PURPLE_THEME, ORANGE_THEME
  SidebarWidth: 270,
  MiniSidebarWidth: 87,
  TopbarHeight: 70,
